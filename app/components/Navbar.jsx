        ...
        <>
            ...
            <nav className={`w-full fixed px-5 lg:p-2 xl:px-[8%] py-4 flex items-center justify-between z-60 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'} ${isScroll ? 'bg-white/60 backdrop-blur-lg shadow-sm dark:bg-[#0b1220]/70 dark:border-b dark:border-white/10' : ''}`}>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-8 py-1.5 border border-gray-500 rounded-full ml-3 font-ovo">contact<Image  src={ isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className='w-3 ' alt="Arrow" /></a>
                ...
                <ul ref={sideMenuRef} className={`flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64  top-0 bottom-0 w-64 z-50 h-screen ${isDarkMode ? 'bg-darkTheme ' : 'bg-lightHover  '} transition duration-500`}>
